...
MODEL_CONFIGS = {
    ...
    "DTDeepVar": {
        ...
        "parameters": [
            ("krad", -21.00, -20.00, -17.00),
            ("beta_n_t1", -5.00, -2.00, 0.00),
            ("e_n_t1", -6.50, -4.00, -1.00),
            ("beta_n_t2", -18.50, -17.00, -16.00),
            ("beta_p_t2", -21.50, -19.00, -17.00),
            ("N_t2", 14.00, 14.50, 17.00),
            ("bkg", -12.00, -10.00, -1.00),
        ],
    },
    "DT": {
        ...
        "parameters": [
            ("k_c", -5.00, -2.00, 0.00),
            ("k_deep", -5.00, -2.00, 0.00),
            ("k_e", -6.50, -4.00, -1.00),
            ("k_rad", -21.00, -20.00, -17.00),
            ("k_aug", -40.00, -37.00, -34.00),
            ("p0", 12.00, 14.00, 18.00),
            ("bkg", -12.00, -10.00, -1.00),
        ],
    },
...
def run_selected_model(time_in, n0_val, physical_parameters):
    if model_name == "BTD":
        return runner(time_in, *physical_parameters[:7], n0_val, physical_parameters[7])[0]
    if model_name == "DTShallowVar":
        return runner(time_in, *physical_parameters[:5], n0_val, physical_parameters[5])[0]
    if model_name == "DTDeepVar":
        return runner(time_in, *physical_parameters[:6], n0_val, physical_parameters[6])[0]
    if model_name == "DT":
        return runner(time_in, n0_val, *physical_parameters)[0]
    if model_name == "ShallowTrapVar":
        return runner(time_in, n0_val, *physical_parameters)[0]
