...
MODEL_CONFIGS = {
    "Extended": {
        "function": TRPL_Extended_Model,
        "parameters": [
            ("ka", -30.00, -25.00, -18.00),
            ("kt", -18.50, -17.00, -16.00),
            ("kb", -21.00, -20.00, -17.00),
            ("kdt", -6.50, -4.00, -1.00),
            ("kdp", -21.50, -19.00, -17.00),
            ("NT", 14.00, 14.50, 17.00),
            ("p0", 12.00, 14.00, 18.00),
            ("bkg", -12.00, -10.00, -1.00),
        ],
    },
    "DualTrap v2": {
        "function": TRPL_DualTrap_Model_v2,
        "parameters": [
            ("krad", -12.00, -10.00, -6.00),
            ("beta_n_t1", -12.00, -9.00, -5.00),
            ("e_n_t1", -6.00, -3.00, 1.00),
            ("N_t1", 14.00, 16.00, 18.00),
            ("beta_n_t2", -12.00, -9.00, -5.00),
            ("bkg", -12.00, -10.00, -1.00),
        ],
    },
    "Deep Trap Variable": {
        ...
        "parameters": [
            ...
            ("e_n_t1", -6.00, -3.00, 1.00),
            ("beta_n_t2", -12.00, -9.00, -5.00),
            ("beta_p_t2", -12.00, -9.00, -5.00),
            ("N_t2", 14.00, 16.00, 18.00),
            ("bkg", -12.00, -10.00, -1.00),
        ],
    },
    "Manuel": {
        "function": TRPL_Manuel_Model,
        "parameters": [
            ("k_c", -12.00, -9.00, -5.00),
            ("k_deep", -6.00, -3.00, 1.00),
            ("k_e", -6.00, -3.00, 1.00),
            ("k_rad", -12.00, -10.00, -6.00),
            ("k_aug", -30.00, -25.00, -18.00),
            ("p0", 12.00, 14.00, 18.00),
            ("bkg", -12.00, -10.00, -1.00),
        ],
    },
    "Shallow Trap Variable": {
        "function": TRPL_ShallowTrapVariable,
        "parameters": [
            ("k_c", -12.00, -9.00, -5.00),
            ("k_e", -6.00, -3.00, 1.00),
            ("k_rad", -12.00, -10.00, -6.00),
            ("k_aug", -30.00, -25.00, -18.00),
            ("NT", 14.00, 16.00, 18.00),
            ("p0", 12.00, 14.00, 18.00),
        ],
    },
}
...
def get_configuration():
    ...
    model_var = tk.StringVar(value="Extended")
    ...
    def rebuild_parameters(*_):
        ...
        for row, (name, lower, mean, upper) in enumerate(rows, start=1):
            active = tk.BooleanVar(value=name not in {"ka", "p0", "bkg"})
...
def run_selected_model(time_in, n0_val, physical_parameters):
    if model_name == "Extended":
        return runner(time_in, *physical_parameters[:7], n0_val, physical_parameters[7])
    if model_name == "DualTrap v2":
        return runner(time_in, *physical_parameters[:5], n0_val, physical_parameters[5])[0]
    if model_name == "Deep Trap Variable":
        return runner(time_in, *physical_parameters[:6], n0_val, physical_parameters[6])[0]
    if model_name == "Manuel":
        return runner(time_in, n0_val, *physical_parameters)
    if model_name == "Shallow Trap Variable":
        return runner(time_in, n0_val, *physical_parameters)
